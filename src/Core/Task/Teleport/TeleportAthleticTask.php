...
class TeleportAthleticTask extends PluginTask
{
	protected $player;
	...
	{
		$this->player->teleport(new Position(254, 4, 254, $this->owner->getServer()->getLevelByName("athletic")));
		$this->player->setSpawn(new Position(254, 4, 254, $this->owner->getServer()->getLevelByName("athletic")));
